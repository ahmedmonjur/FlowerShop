...
class Products_all extends CI_Controller {
		...
		//-----------------------------------------------------Start Product_type View All-------------------------------------------------------------
     	...
     	public function All(){ // Function Declare for (Product_type View All)
		    ...
		    $config['base_url'] = site_url('controlpanel/Products_all/all');
	        ...
	        $data['Products_all'] = $query->result_array();
	      ...
	      // $data['p_']=$q->result_array();
				...
				$this->load->view('controlpanel/left_nav',$data); //Showing page(Left Nav) of Product_type All in controlpanel
		     	...
		     	$data['title']='Product All';
		     	
		    
     			$data['s_tab']='s_tab1';
     			$this->load->view('controlpanel/products_all_view',$data); 
		...
		//-----------------------------------------------------Start Product_type View For (Edit/Reset)-------------------------------------------------------------
     		...
     		public function view($id){ // Function Declare for (Product_type  Single View) For Update/Reset
		...
		//		$this->load->view('controlpanel/prtype_single_view.php',$data);
