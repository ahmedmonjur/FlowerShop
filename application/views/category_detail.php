											...
											<?php foreach($category_product as $category_products){?>
												<div class="col-md-3 col-md2">
													<div class="col-md1 simpleCart_shelfItem">														   
													    <a href="<?php echo base_url(); ?>home/product/<?php echo $category_products['product_id'];?>"><img src="<?php echo base_url();?>site_elements/Product_Image/<?php echo $category_products['image']; ?>"class="img-responsive" width="185px" height="207px"></a>
														<h3><?php echo $category_products['product_name']; ?></h3>														
														<div class="price">
															<h5 class="item_price">TK. &nbsp;<?php echo $category_products['product_unit_price'];?></h5>
