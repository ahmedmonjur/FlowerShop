								...
								<div class="col-sm-9 padding-right">
									...
									<div class="content-top">
										...
										<?php
											...
											else if(isset($category_product_type))
											  {										
										?>	  
										<div class="content-top1">
											<?php foreach($category_product_type as $category_product_types){?>
												<div class="col-md-3 col-md2">
													<div class="col-md1 simpleCart_shelfItem">														   
													    <a href="<?php echo base_url(); ?>home/product/<?php echo $category_product_types['product_id'];?>"><img src="<?php echo base_url();?>site_elements/Product_Image/<?php echo $category_product_types['image']; ?>"class="img-responsive" width="185px" height="207px"></a>
														<h3><?php echo $category_product_types['product_name']; ?></h3>														
														<div class="price">
															<h5 class="item_price">TK. &nbsp;<?php echo $category_product_types['product_unit_price'];?></h5>
															<a href="<?php echo base_url(); ?>/index.php/home/product/<?php echo $category_product_types['product_id'];?>" class="item_add">View Details</a>
