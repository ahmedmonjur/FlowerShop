												...
												<div class="col-md-9">
													<div class="col-md-5 grid">		
														<div class="flexslider">
															  <ul class="slides">
																<li data-thumb="site_elements/Product_Image/<?php echo $product['image']; ?>">
																	<div class="thumb-image"> <img src="<?php echo site_url(); ?>site_elements/Product_Image/<?php echo $product['image']; ?>" data-imagezoom="true" class="img-responsive" width="100px"> </div>
																</li>								
															  </ul>
														</div>
													</div>	
													<div class="col-md-7 single-top-in">
														<div class="single-para simpleCart_shelfItem">
															...
															<h1 style="color:black;margin-top:5px;">Product Details</h1>
															<p style="padding-top:20px;"><?php echo $product['product_description'] ?></p>
															<h1 style="color:black;margin-top:5px;">Material & Care</h1>
															<p> Brasso Jorjet</p>
															<p> Dry Clean</p>
															<h1 style="color:black;margin-top:5px;">TK. &nbsp;<?php echo $product['product_unit_price'] ?></h1>
															<h1 style="color:black;margin-top:5px;">Available Stock : <strong style="background:#005a00;color:#fff;padding:2px 8px;"> stock </strong></h1>
												...
												<div class="col-md-3 product-bottom">
													<!--categories-->
														<div class=" rsidebar span_1_of_left">
															<h3 class="cate">Popular Categories</h3>
															<ul class="menu-drop">
																
																		  <li class="item1"><a href="#">categorya></li>
