										...
										<form class="form-horizontal form-label-left" novalidate name="product_form" id="multiselectForm" role="form" autocomplete="off"   method="post" action="<?php echo $action;?>">
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"  value="<?php  echo $key['category_code']; ?>" name="caCode" type="text">
												</div>
											</div>
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"  value="<?php  echo $key['category_name']; ?>" name="caName" type="text">
												</div>
											</div>
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<textarea id="textarea" required="required" name="des" class="form-control col-md-7 col-xs-12"><?php echo $key['category_descrip']; ?></textarea>
												</div>
											</div>
											<?php } ?>
											<div class="item form-group">
