							  ...
							  <div class="x_title">
							   ...
							   <div class="x_content">
									...
									<!---	<th class="center">Category</th>
									  ...
									  <tbody>
												<?php foreach ($Products_all as $key): $segment++; ?>
											<tr>
												<th scope="row" style="font-weight: normal;" class="center"><?php echo $segment; ?></th>
												<td class="center"><?php   echo $key['product_name'];   ?></td>
												<?php 
											//	foreach ($Categories as $ca) {
													//	if($key['category_id'] == $ca['category_id'])
													//	{
															//echo '<td class="center">'.$ca['category_name'].'</td>';
														//}
													//}
												?>
										<!--		<td class="center"><?php   //echo $key['product_type'];   ?></td>--->
												<td class="center"><?php   echo $key['product_unit_price'];   ?></td>
												<td class="center"><?php   echo $key['status'];   ?></td>
												<td class="center"><?php   echo $key['quantity'];   ?></td>
												<td class="center"><?php   echo $key['doc'];   ?></td>
												<td class="center"><?php   echo $key['dom'];   ?></td>
												

												<td class="center">[ <a href="<?php echo site_url('controlpanel/Products/view/'.$key['product_id']); ?>">View</a> ]  [ <a onClick='return confirm("Are you sure want to delete this category ?");' href="<?php echo site_url('controlpanel/Products/delete/'.$key['product_id']); ?>">Delete</a> ]</td>
