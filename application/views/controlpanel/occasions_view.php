									...
									<table id="datatable" class="table table-striped table-bordered">
									  <thead>
											<tr>
												...
												<th class="center">Occasion Name</th>
												<th class="center">Occasion Description</th>
									  ...
									  <tbody>
												<?php foreach ($occasions as $key): $segment++; ?>
											<tr>
												<th scope="row" style="font-weight: normal;" class="center"><?php echo $segment; ?></th>
												<td><?php   echo $key['occasion_name'];   ?></td>
												
												<td class="center"><?php   echo $key['description'];   ?></td>
												<td class="center"><?php   echo $key['status'];   ?></td>
												<td class="center"><?php   echo $key['doc'];   ?></td>
												<td class="center"><?php   echo $key['dom'];   ?></td>
												<td class="center"><?php   echo $key['image'];   ?></td>

												<td class="center">[ <a href="<?php echo site_url('controlpanel/Occasions/view/'.$key['occasion_id']); ?>">View</a> ]  [ <a onClick='return confirm("Are you sure want to delete this occasion ?");' href="<?php echo site_url('controlpanel/Occasions/delete/'.$key['occasion_id']); ?>">Delete</a> ]</td>
