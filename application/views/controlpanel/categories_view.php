									...
									<table id="datatable" class="table table-striped table-bordered">
									  ...
									  <tbody>
											...
											<tr>
												...
												<td class="center"><?php   echo $key['category_code'];   ?></td>
												<td><?php   echo $key['category_name'];   ?></td>
												<td class="center">
													<?php
														$c=0;
														foreach ($p_ as $p) {
															if($key['category_id']==$p['category_id'])
															{
																$c++;
															}
												...
												<td class="center"><?php   echo $key['category_descrip'];   ?></td>
												<td class="center"><?php   echo $key['catalog'];   ?></td>
												<td class="center"><?php   echo $key['status'];   ?></td>
												<td class="center"><?php   echo $key['doc'];   ?></td>
												<td class="center"><?php   echo $key['dom'];   ?></td>

												<td class="center">[ <a href="<?php echo site_url('controlpanel/Categories/view/'.$key['category_id']); ?>">View</a> ]  [ <a onClick='return confirm("Are you sure want to delete this category ?");' href="<?php echo site_url('controlpanel/Categories/delete/'.$key['category_id']); ?>">Delete</a> ]</td>
